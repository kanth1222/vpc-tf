...
locals {
  ...
  // region_abbreviation     = "local.region_settings.var.aws_region.region_abbreviation"
  // availability_zones      = "local.region_settings.var.aws_region.availability_zones"
}